define(function (require) {
  ...
  module.constant('quickRanges', [
    ...
    { from: 'now/d',    to: 'now',      display: '今天之前',        section: 0 },
    { from: 'now/w',    to: 'now',      display: '本周之前',          section: 0 },
    { from: 'now/M',    to: 'now',      display: '本月之前',         section: 0 },
    { from: 'now/y',    to: 'now',      display: '今年之前',          section: 0 },
